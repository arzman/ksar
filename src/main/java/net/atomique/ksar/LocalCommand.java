    ...
    public LocalCommand(KSar hissar, String hiscommand) {
        ...
        try {
            ...
            if (GlobalOptions.getInstance().hasUI() ) {
                JOptionPane.showMessageDialog(GlobalOptions.getInstance().getUI(), "There was a problem while running the command " + command, "Local error", JOptionPane.ERROR_MESSAGE);
            } else {
