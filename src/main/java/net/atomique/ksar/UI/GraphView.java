...
public class GraphView extends javax.swing.JPanel {
	...
	private void csvButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_csvButtonActionPerformed
		...
		filename = askSaveFilename("Export CSV", Config.getInstance().getLastExportDirectory());

		if (filename != null) {

			File zefile = new File(filename);
			Config.getInstance().setLastExportDirectory(zefile.getParent());
	...
	private void jpgBuittonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jpgBuittonActionPerformed
		String filename = askSaveFilename("Export JPG", Config.getInstance().getLastExportDirectory());
		if (filename != null) {

			thegraph.saveJPG(null, null, filename, Config.getInstance().getImageWidth(),
					Config.getInstance().getImageHeight());
		}
	...
	private void pngButtonActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_pngButtonActionPerformed
		String filename = askSaveFilename("Export PNG", Config.getInstance().getLastExportDirectory());
		if (filename != null) {

			thegraph.savePNG(null, null, filename, Config.getInstance().getImageWidth(),
					Config.getInstance().getImageHeight());
		}
	...
	private String askSaveFilename(String title, File chdirto) {
		...
		int returnVal = chooser.showSaveDialog(GlobalOptions.getInstance().getUI());
