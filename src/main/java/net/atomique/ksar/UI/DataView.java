...
public class DataView extends javax.swing.JInternalFrame {
	...
	private void PDFMenuActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_PDFMenuActionPerformed
		GraphSelection tmp = new GraphSelection(GlobalOptions.getInstance().getUI(), true, this);
		...
		tmp = null;
		String filename = askSaveFilename("Export PDF", Config.getInstance().getLastExportDirectory());
		if (filename != null) {
	...
	private void CSVMenuActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_CSVMenuActionPerformed
		...
		if (tmp.OkforExport) {
			...
			String filename = askSaveFilename("Export CSV", Config.getInstance().getLastExportDirectory());
			if (filename != null) {
	...
	public void doExportPDF(String filename) {
		...
		mydial.pack();
		mydial.setLocationRelativeTo(GlobalOptions.getInstance().getUI());
